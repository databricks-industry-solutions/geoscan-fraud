...
job_json = {
        ...
        "tasks": [
            {
                "job_cluster_key": "geofraud_cluster",
                "notebook_task": {
                    "notebook_path": f"00_geofraud_context"
                },
                "task_key": "00_geofraud",
                "description": ""
            },
            {
                "job_cluster_key": "geofraud_cluster",
                "notebook_task": {
                    "notebook_path": f"01_geofraud_clustering"
                },
                "task_key": "01_geofraud",
                "libraries": [
                  {
                    "maven": {
                      "coordinates": "com.databricks.labs:geoscan:0.2.8"
                    }
                  },
                  {
                    "maven": {
                      "coordinates": "com.uber:h3:3.7.2"
                    }
                  }
                ],
                "depends_on": [
            ...
            },
            {
                "job_cluster_key": "geofraud_cluster",
                "notebook_task": {
                    "notebook_path": f"02_geofraud_fraud",
                },
                "task_key": "02_geofraud",
                "libraries": [
                  {
                    "maven": {
                      "coordinates": "com.databricks.labs:geoscan:0.2.8"
